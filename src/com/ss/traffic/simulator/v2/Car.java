...
{
    /**
     * Stores x/y position of car
     * y position remains 0 throughout simulation
    * */
    private int xPosition;
    private int yPosition = 0;

    /**
     * Thread safe var, ensures current thread is running before executing run implementation
     */
    ...
    public int getSpeed()
    {
        if(isRunning.get())
        {
            ...
            /**
             * Dist between two intersections 1000m,
             * thus total distance to cover is 3000m.
             */
                speed = 3*60;
        } else
            speed = 0;
